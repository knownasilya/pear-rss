...
class SocketGenericError extends (0, _Error.RefailError)(SocketErrorTypeId, "SocketError") {
  get message() {
...
class SocketCloseError extends (0, _Error.TypeIdError)(SocketErrorTypeId, "SocketError") {
  /**
   * @since 1.0.0
   */
  static is(u) {
    ...
    if (ws.readyState !== 1) {
      return Effect.async(resume => {
        ...
        onTimeout: () => new SocketGenericError({
          reason: "OpenTimeout",
          error: "timeout waiting for \"open\""
        })
