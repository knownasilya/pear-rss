 ...
 * @category error
 */
class RequestError extends (0, _Error.RefailError)(TypeId, "RequestError") {
  /**
   * @since 1.0.0
   */
  [Respondable.symbol]() {
 ...
 * @category error
 */
class RouteNotFound extends (0, _Error.TypeIdError)(TypeId, "RouteNotFound") {
  constructor(options) {
    super(options);
...
class ResponseError extends (0, _Error.RefailError)(TypeId, "ResponseError") {
  /**
   * @since 1.0.0
   */
  [Respondable.symbol]() {
...
class ServeError extends (0, _Error.RefailError)(TypeId, "ServeError") {}
/**
 * @since 1.0.0
 */
