...
exports.withUndiciOptions = exports.makeDispatcher = exports.make = exports.layerWithoutDispatcher = exports.layer = exports.dispatcherLayerGlobal = exports.dispatcherLayer = exports.currentUndiciOptions = exports.Dispatcher = void 0;
...
/** @internal */
const currentUndiciOptions = exports.currentUndiciOptions = /*#__PURE__*/(0, _GlobalValue.globalValue)( /*#__PURE__*/Symbol.for("@effect/platform-node/NodeHttpClient/currentUndici"), () => FiberRef.unsafeMake({}));
/** @internal */
const withUndiciOptions = exports.withUndiciOptions = /*#__PURE__*/(0, _Function.dual)(2, (self, options) => Effect.locally(self, currentUndiciOptions, options));
/** @internal */
...
class ClientResponseImpl extends Inspectable.Class {
  ...
  get stream() {
    return NodeStream.fromReadable(() => this.source.body, _ => new Error.ResponseError({
  ...
  get json() {
    return Effect.tryMap(this.text, {
      ...
      catch: _ => new Error.ResponseError({
        request: this.request,
        response: this,
        reason: "Decode",
        error: _
...
/** @internal */
const layerWithoutDispatcher = exports.layerWithoutDispatcher = /*#__PURE__*/Layer.effect(Client.HttpClient, /*#__PURE__*/Effect.map(Dispatcher, make));
/** @internal */
