...
/** @internal */
export const currentUndiciOptions = /*#__PURE__*/globalValue( /*#__PURE__*/Symbol.for("@effect/platform-node/NodeHttpClient/currentUndici"), () => FiberRef.unsafeMake({}));
/** @internal */
export const withUndiciOptions = /*#__PURE__*/dual(2, (self, options) => Effect.locally(self, currentUndiciOptions, options));
/** @internal */
...
/** @internal */
export const layerWithoutDispatcher = /*#__PURE__*/Layer.effect(Client.HttpClient, /*#__PURE__*/Effect.map(Dispatcher, make));
/** @internal */
